...
Original file is located at
    https://colab.research.google.com/drive/1ZzLZNyflPF82FQVG4lcyjXGSJERKWq4M
"""
...
new_model = load_model("/content/drive/MyDrive/model_checkpoint(10).h5")
x = BatchNormalization()(new_model.output)
x = Dropout(0.5)(x)
outputs = Dense(10, activation='softmax')(x)

model = Model(inputs=new_model.input, outputs=outputs)
...
!unzip /content/drive/MyDrive/data1.zip
!unzip /content/drive/MyDrive/data.zip
!unzip /content/drive/MyDrive/data2.zip
